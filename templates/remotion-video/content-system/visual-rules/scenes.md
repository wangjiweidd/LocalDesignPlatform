...
**Track:** knowledge-sharing / Odin  
**Layout:** 1440×1920 pale teaching-paper background. Top sticker phrase, middle screenshot/video/material stand-in, bottom narration subtitle.  
**Key visual:** Real or generated material screenshot/document/video area, not abstract decoration.  
**Transition in:** Material scales up gently; labels stagger in.  
**Use when:** Opening a video with the evidence or source material that will be explained.
...
**Track:** knowledge-sharing / Odin  
**Layout:** 1440×1920 pale background. Large dark material/text blocks fill the upper evidence zone, with red hand-drawn circle/underline/arrow and one bottom narration subtitle.  
**Key visual:** The annotation points to the exact material being discussed.  
**Transition in:** Document appears first; highlights and red marks draw in after the narration starts.  
**Use when:** Explaining why a project answer, portfolio page, or interview material works or fails.
...
**Track:** knowledge-sharing / Odin  
**Layout:** 1440×1920 pale background. Top sticker phrase, three black cause-effect bars in the middle, optional colored stamp row, one bottom narration subtitle.  
**Key visual:** A concrete case is broken into a reusable method.  
**Transition in:** Card slides in; labels pop in sequentially.  
**Use when:** Turning a real project into a repeatable framework.
